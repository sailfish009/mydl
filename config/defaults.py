...
# Path (possibly with schema like catalog:// or mydl://) to a checkpoint file
...
# See mydl/solver/build.py for LR scheduler options
...
# and access it with:
#
# from mydl.config import global_cfg
