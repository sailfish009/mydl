...
from mydl.utils import comm
from mydl.utils.collect_env import collect_env_info
from mydl.utils.env import seed_all_rng
from mydl.utils.events import CommonMetricPrinter, JSONWriter, TensorboardXWriter
...
class DefaultTrainer(SimpleTrainer):
    ...
    It is only guaranteed to work well with the standard models and training workflow in mydl.
    ...
    def build_model(cls, cfg):
        ...
        It now calls :func:`mydl.modeling.build_model`.
    ...
    def build_optimizer(cls, cfg, model):
        ...
        It now calls :func:`mydl.solver.build_optimizer`.
    ...
    def build_lr_scheduler(cls, cfg, optimizer):
        """
        It now calls :func:`mydl.solver.build_lr_scheduler`.
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        It now calls :func:`mydl.data.build_detection_test_loader`.
        Overwrite it if you'd like a different data loader.
        """
