...
from mydl.structures import BoxMode, PolygonMasks, Boxes
...
def load_sem_seg(gt_root, image_root, gt_ext="png", image_ext="jpg"):
    ...
    Returns:
        list[dict]:
            a list of dicts in mydl standard format without instance-level
            annotation.
...
def convert_to_coco_dict(dataset_name):
    """
    Convert a dataset in mydl's standard format into COCO json format

    Generic dataset description can be found here:
    https://mydl.readthedocs.io/tutorials/datasets.html#register-a-dataset
    ...
    Args:
        dataset_name:
            ...
            must be registered in DatastCatalog and in mydl's standard format
    Returns:
            ...
            if "keypoints" in annotation:
                ...
                for idx, v in enumerate(keypoints):
                    if idx % 3 != 2:
                        ...
                        # https://github.com/facebookresearch/mydl/pull/175#issuecomment-551202163
                        keypoints[idx] = v - 0.5
...
def convert_to_coco_json(dataset_name, output_file, allow_cached=True):
    ...
    dataset_name must be registered in DatasetCatalog and in mydl's standard format.

    Args:
        dataset_name:
            reference from the config file to the catalogs
            must be registered in DatasetCatalog and in mydl's standard format
...
if __name__ == "__main__":
    ...
    Usage:
        python -m mydl.data.datasets.coco \
