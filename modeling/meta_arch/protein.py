...
from mydl.structures import ImageList
from mydl.utils.events import get_event_storage
from mydl.utils.logger import log_first_n
...
__all__ = ["ProteinResnet"]


@META_ARCH_REGISTRY.register()
class ProteinResnet(nn.Module):
    """
    Protein Resnet. Any models that contains the following three components:
