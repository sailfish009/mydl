...
def export_caffe2_detection_model(model: torch.nn.Module, tensor_inputs: List[torch.Tensor]):
    """
    Export a mydl model via ONNX.

    Arg:
        model: a caffe2-compatible version of mydl model, defined in caffe2_modeling.py
    ...
    # Record necessary information for running the pb model in mydl system.
